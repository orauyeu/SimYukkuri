...
fun createYukkuri(scene: GameScene, imageList: ImageList, x: Double, y: Double, z: Double, growthStage: Growth.GrowthStage, messageCollection: MessageCollection, isIdiot: Boolean): Yukkuri {
